    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-green-50 flex items-center justify-center p-4">
        ...
        >
          ...
          <p className="text-gray-600 mb-8">You can now sign in with your credentials.</p>
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-50 flex items-center justify-center p-4 sm:p-6">
      ...
      >
        <div className="text-center mb-6 sm:mb-8">
          ...
          <p className="text-gray-600 mt-1 sm:mt-2 text-sm sm:text-base">Start shortening links today</p>
        </div>
