  ...
  useEffect(() => {
    const fetchLiveStats = async () => {
      try {
        ...
        // Get actual total clicks from clicks table
                  ...
                  >
                    <div>
                      <div className="flex items-center justify-between mb-2">
                        <code className="text-blue-200 font-mono text-sm blur-md" title="Short code blurred for privacy">
                          /{link.short_code}
                        </code>
                      ...
                      <p className="text-gray-300 text-sm truncate" title="URL partially hidden for privacy">
                        {link.original_url.length > 30 
                          ? `${link.original_url.substring(0, 15)}...${link.original_url.substring(link.original_url.length - 10)}`
                          : link.original_url
                        }
                      </p>
                    </div>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li><a href="mailto:dmcreatorstudio04@gmail.com" className="hover:text-white">dmcreatorstudio04@gmail.com</a></li>
              </ul>
            </div>
            <div>
